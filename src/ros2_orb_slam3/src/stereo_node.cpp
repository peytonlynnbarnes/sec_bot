...
StereoMode::StereoMode() : Node("stereo_node_cpp"), pAgent(nullptr)
{
    ...
    subLeftImgMsg_subscription_ = this->create_subscription<sensor_msgs::msg::Image>(subLeftImgMsgName, 1, std::bind(&StereoMode::LeftImg_callback, this, _1));
    subRightImgMsg_subscription_ = this->create_subscription<sensor_msgs::msg::Image>(subRightImgMsgName, 1, std::bind(&StereoMode::RightImg_callback, this, _1));

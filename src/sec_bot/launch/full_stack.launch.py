...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Step 2: Launch simulated camera
        TimerAction(
            period=2.0,
            actions=[
                IncludeLaunchDescription(
        ...
        # Step 3: Launch sim_multi_ball_tracker node (delayed more for stability)
        TimerAction(
            period=5.0,
            actions=[
                Node(
                    package='ball_tracker',
                    executable='multi_ball_tracker',
                    name='multi_ball_tracker',
